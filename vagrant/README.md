...
This section covers the installation of vagrant on a M1/M2/M3 Mac as it utilises the arm chipset. 
I have used vagrant here to automate the installation of the base VM and to get the majority of the operating system related tasks configured prior to kubernetes configuration. 
